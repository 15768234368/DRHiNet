...
from noise_layers.jpeg import JpegSS, Jpeg_DCT, Jpeg_CIN
        ...
        for layer in noise_layers:
            if type(layer) is str:
                if layer == 'JpegPlaceholder':
                    ...
                    self.noise_layers.append(JpegSS())
                elif layer == 'JpegDct':
                    self.noise_layers.append(Jpeg_DCT())
                elif layer == 'JpegCin':
                    self.noise_layers.append(Jpeg_CIN())
                else:
